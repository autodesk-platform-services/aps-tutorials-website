...
<CodeBlockTabs NET6={WorkitemForNet} NodeJS={WorkitemForNodejs} />
...
> Both input and output files are saved in OSS Buckets, you can use [View Models](https://tutorials.autodesk.io/tutorials/simple-viewer/) tutorial to view them.

![](./_shared/_images/run_sample_modifymodels.gif)
...
<CodeBlockTabs NET6={DebugForNet} NodeJS={DebugForNodejs} />
