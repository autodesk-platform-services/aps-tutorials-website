...
> You may download the Bundle ZIP into the bundles/ (Node.js) or /forgeSample/wwwroot/bundles (.NET Core) folder and skip this section

## Create a new project

```json title=SampleAutomation.cs
using Inventor;
