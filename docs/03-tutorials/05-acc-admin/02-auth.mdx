...
<details>
    ...
    <YouTubeVideo id="aQ_DNMw16bE" si="QLrFdC9vRs-i0NWs" title="Forma Admin for .NET: Intro & Setup" />
</details>
...
<details>
    ...
    <YouTubeVideo id="FNa4UT__e8c" si="W2B9voKvP2KLIZfn" title="Forma Admin for Node.js: Developer Environment" />
</details>
