...
```js title=wwwroot/js/ApsDesignAutomation.js
...
At this point you can run your project, just hit F5, open browser and enter [http://localhost:8080](http://localhost:8080) 
The html interface is displayed indicating that your project was created correctly. None of the buttons should work... let's move forward.
