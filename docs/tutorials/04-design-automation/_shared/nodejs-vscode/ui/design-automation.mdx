import VsCodeFolderExplorerImg from "../../_images/vscode_nodejsfs.webp";
...
At this point you can run your project, just hit F5, open browser and enter http://localhost:8080/, html interface is displayed indicating that
your project was created correctly. None of the buttons should work... let's move
forward.
