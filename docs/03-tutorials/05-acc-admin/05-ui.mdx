...
<details>
    ...
    <YouTubeVideo id="TwfqTQM_LMI" si="PcY03Zf36W1TiK5x" title="ACC Admin for .NET: UI Framework" />
</details>
...
<details>
    ...
    <YouTubeVideo id="Z2Uius077u4" si="uOm1Ue_1tkgokT2u" title="ACC Admin for Node.js: UI Framework" />
</details>
