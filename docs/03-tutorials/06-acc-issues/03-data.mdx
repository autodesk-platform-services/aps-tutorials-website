...
<details>
    ...
    <YouTubeVideo id="SETMRe7L198" si="uzV2YYfOueWtL5VB" title="ACC Issues for .NET: Project Browsing" />
</details>
...
<details>
    ...
    <YouTubeVideo id="plLPEokqCos" si="YSGnFZfLMYhKocPu" title="ACC Issues for Node.js: Project Browsing" />
</details>
