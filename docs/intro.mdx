...
![Sign Up](./_shared/developer-portal-logged-out.webp)
...
![My Apps](./_shared/developer-portal-logged-in.webp)

Next, click on the _Create application_ button:

![Create App](./_shared/my-apps.webp)

Enter the name of your application, and click the _Create_ button:

![App Name](./_shared/create-app.webp)

And your application is now ready. Let's store your _Client ID_ and _Client Secret_
credentials as we will need these soon!

![App Overview](./_shared/app-overview.webp)
...
![Save Changes](./_shared/save-changes.png)
