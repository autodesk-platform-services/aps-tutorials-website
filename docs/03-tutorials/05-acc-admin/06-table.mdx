...
<details>
    ...
    <YouTubeVideo id="fEa68Pxk90E" si="CLTVol1C5-1stWqk" title="ACC Admin for .NET: Table & CSV Prepare" />
</details>
...
<details>
    ...
    <YouTubeVideo id="HXAJklkRQnE" si="M8F-G0zdNEJ2-JMD" title="ACC Admin for Node.js: Table & CSV Prepare" />
</details>
