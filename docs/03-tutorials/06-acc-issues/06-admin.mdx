...
Some issue attributes are related to project members, we will use Forma Admin API to get the information. This sample demos how to fetch project users.
...
## Forma Admin SDK
First, let's include the Forma Admin SDK:
