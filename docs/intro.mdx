...
Forge-based products such as [Autodesk BIM 360](https://www.autodesk.com/bim-360).
...
to provide your application access to a specific product. If you are _not_ planning
to integrate your application with other Forge-based products, you can skip this step.
...
And that's it. Now your Forge application can use [Document Management API](https://forge.autodesk.com/en/docs/data/v2/developers_guide/overview/)
