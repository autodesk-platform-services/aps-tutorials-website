...
<details>
    ...
    <YouTubeVideo id="TwfqTQM_LMI" si="PcY03Zf36W1TiK5x" title="Forma Admin for .NET: UI Framework" />
</details>
...
<details>
    ...
    <YouTubeVideo id="Z2Uius077u4" si="uOm1Ue_1tkgokT2u" title="Forma Admin for Node.js: UI Framework" />
</details>
...
<head>
    ...
    <title>Autodesk Platform Services: Forma Administrator</title>
</head>

<body>
    <div id="header">
        <img class="logo" src="https://cdn.autodesk.io/logo/black/stacked.png" alt="Autodesk Platform Services">
        <span class="title">Forma Administrator</span>
