...
:::tip 
If you're developing with Node.js, you can use TypeScript with the Forge Viewer. Run
```bash
...
- https://raw.githubusercontent.com/autodesk-forge/forge-simple-viewer-nodejs/develop/wwwroot/favicon.ico
- https://raw.githubusercontent.com/autodesk-forge/forge-simple-viewer-nodejs/develop/wwwroot/logo.png
