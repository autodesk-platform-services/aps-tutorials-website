...
The base URI schema of **Forma Issues API** is: `https://developer.api.autodesk.com/construction/issues/v1/projects/:projectId`
, where the **projectId** is a required URI parameter. In this step we'll extend the server to browse the Forma projects , in order to fetch **projectId**. 
...
<details>
    ...
    <YouTubeVideo id="SETMRe7L198" si="uzV2YYfOueWtL5VB" title="Forma Issues for .NET: Project Browsing" />
</details>
...
<details>
    ...
    <YouTubeVideo id="plLPEokqCos" si="YSGnFZfLMYhKocPu" title="Forma Issues for Node.js: Project Browsing" />
</details>
