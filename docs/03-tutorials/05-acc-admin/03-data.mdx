...
import DotNetVsCodeTest from './_shared/dotnet/data/test.mdx';

import YouTubeVideo from '@site/src/components/YouTubeVideo';

# Project Browsing

In this step we'll extend our server so that we can browse the projects of Forma for Construction. 
